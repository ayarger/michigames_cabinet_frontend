	...
	public static void ExtrudeMesh (Mesh srcMesh, Mesh extrudedMesh, Matrix4x4[] extrusion, Edge[] edges, bool invertFaces)
	{
		...
		for (int i=0;i<extrusion.Length;i++)
		{
			...
			foreach (Edge e in edges)
			{
				...
				// TEST: planar UV on sides?
				// best so far
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[0]].x+0.01f, inputUV[e.vertexIndex[0]].y+0.01f);
				
				
//				uvs[v+0] = new Vector2 (0, 0);
//				uvs[v+1] = new Vector2 (0.5f,0.5f);
//				uvs[v+0] = new Vector2 (0.6f, 0.6f); uvs[v+1] = new Vector2 (1,1); 

//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y); 
//				uvs[v+1] = new Vector2 (0,0);
				
				
//				uvs[v+0] = new Vector2 (vertices[v+0].x, vertices[v+0].y);
//				uvs[v+1] = new Vector2 (vertices[v+1].x, vertices[v+1].y);
				
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y);
				
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, 0);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, 1);

				// 70% ok!
//					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x-0.01f, inputUV[e.vertexIndex[0]].y-0.01f);
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y);
...
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y);
//					}else{
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0625f);
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y);
//					}
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y);
//					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[1]].x-0.01f, inputUV[e.vertexIndex[1]].y-0.01f);
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y);
					
//					if (uvs[v+0].x<0) uvs[v+0].x=0;
//					if (uvs[v+0].y<0) uvs[v+0].y=0;
//					if (uvs[v+1].x<0) uvs[v+1].x=0;
//					if (uvs[v+1].y<0) uvs[v+1].y=0;
					
//					Debug.Log ("v"+v+" uv: ("+uvs[v+0].x+","+uvs[v+0].y+") - ("+ uvs[v+1].x+","+uvs[v+1].y+")");
...
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x+0.001f, inputUV[e.vertexIndex[1]].y+0.001f);


//				uvs[v+0] = new Vector2 (Mathf.Min(inputUV[e.vertexIndex[0]].x,inputUV[e.vertexIndex[1]].x), Mathf.Min(inputUV[e.vertexIndex[0]].y,inputUV[e.vertexIndex[1]].y));
//				uvs[v+1] = new Vector2 (Mathf.Max(inputUV[e.vertexIndex[0]].x,inputUV[e.vertexIndex[1]].x), Mathf.Max(inputUV[e.vertexIndex[0]].y,inputUV[e.vertexIndex[1]].y));
				
//				Debug.Log ("v"+v+" uv: ("+inputUV[e.vertexIndex[0]].x+","+inputUV[e.vertexIndex[0]].y+") - ("+ inputUV[e.vertexIndex[1]].x+","+inputUV[e.vertexIndex[1]].y+")");
				
				// maps whole map as "mirrored" (sometimes ok?) **Same as BOX mapping in max?
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, vcoord);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].y, vcoord);
...
//                uvs[v+1] = new Vector2 (1, 1);
				...
				// BEST 8.2.2012
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x+0.001f, inputUV[e.vertexIndex[0]].y);
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.001f);
...
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y);
					...
					//Debug.Log("inp: " + inputVertices[e.vertexIndex[0]]);
					uvs[v+0] = inputVertices[e.vertexIndex[0]]/16;
					uvs[v+1] = inputVertices[e.vertexIndex[1]]/16;
					
//				}else{
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y);
//					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y);
//				}

//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x+0.0001f, inputUV[e.vertexIndex[0]].y);
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0001f);

//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x-0.0001f, inputUV[e.vertexIndex[0]].y); // ok other sides
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0001f);
...
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0001f);
				...
				// top, right, left, OK!!!!!!!!!!!!!
				/*
				if (inputUV[e.vertexIndex[0]].y>=inputUV[e.vertexIndex[1]].y)
				{
					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x-0.000001f, inputUV[e.vertexIndex[0]].y); 
				}else{
					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x+0.000001f, inputUV[e.vertexIndex[0]].y);
				}
				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.000001f);
				*/
				...
				if (inputUV[e.vertexIndex[0]].x<inputUV[e.vertexIndex[1]].x) 
				{
					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0001f);
				}else{
					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x-0.0001f, inputUV[e.vertexIndex[1]].y+0.0001f);
				}*/
...
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0001f);
				...
				// bottom & right ok
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, inputUV[e.vertexIndex[0]].y+0.0001f);
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x-0.0001f, inputUV[e.vertexIndex[1]].y);


//				if (vcoord==1)	uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x-0.0001f, inputUV[e.vertexIndex[0]].y); // ok other sides
//				if (vcoord==0)	uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x+0.0001f, inputUV[e.vertexIndex[0]].y); // ok other sides
//                uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].x, inputUV[e.vertexIndex[1]].y-0.0001f);


				// almost!
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, vcoord*0.1f);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].y, vcoord*0.1f);
//				Debug.Log(normals[v+0]);

				// yellow correct
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, 0);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].y, 0);

				// blue correct
//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, 0.99f);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].y, 0.99f);

//				uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, 0);
//				uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[0]].y, 0);


//				if ((normals[e.vertexIndex[1]].x == 0) || (normals[e.vertexIndex[0]].x == 0))
//				{
//					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, vcoord*0.01f);
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].y, vcoord*0.01f);
//					uvs[v+0] = new Vector2 (0,0);
//					uvs[v+1] = new Vector2 (1,1);
//				}else{
//					uvs[v+0] = new Vector2 (0.5f,0.5f);
//					uvs[v+1] = new Vector2 (0.5f,0.5f);
//					uvs[v+0] = new Vector2 (inputUV[e.vertexIndex[0]].x, vcoord*-0.01f);
//					uvs[v+1] = new Vector2 (inputUV[e.vertexIndex[1]].y, vcoord*-0.01f);
//				}
